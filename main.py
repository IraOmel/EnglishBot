...
def incorrect_cmd(message):
    ...
    if message.text == "Ігри":
        ...
        keyboard.add(types.InlineKeyboardButton(text='<', callback_data="back"))
        keyboard.add(types.InlineKeyboardButton(text='>', callback_data="forward"))
...
def callback_worker(call):
    ...
    if call.data == "answer":
        ...
        keyboard.add(types.InlineKeyboardButton(text='<', callback_data="back"))
        keyboard.add(types.InlineKeyboardButton(text='>', callback_data="forward"))
        bot.send_message(call.message.chat.id, "Оберіть з наступних лекцій:", reply_markup=keyboard)
